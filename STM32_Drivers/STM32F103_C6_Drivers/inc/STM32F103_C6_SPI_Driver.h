...
//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
#define SPI_Communication_FullDuplex_2Line_Mode					(uint32_t)(0)
#define SPI_Communication_FullDuplex_2Line_RXONLY_Mode			(uint32_t)(1<<10)
#define SPI_Communication_HalfDuplex_1Line_RX_MODE				(uint32_t)(1<<15)
#define SPI_Communication_HalfDuplex_1Line_TX_MODE				(uint32_t)(1<<15 | 1<<14)


//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
//@ref SPI_FrameFromat_Mode
//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
...
//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
//@ref SPI_CLkPolarity_Mode
//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
#define SPI_ClkPolarity_Idle_High								(uint32_t)(1<<1)  	//High means Raising edge
#define SPI_ClkPolarity_Idle_Low								(uint32_t)(0)		//Low means falling edge
...
#define SPI_NSS_SW_Reset										(uint32_t)(1<<9)
#define SPI_NSS_SW_Set											(uint32_t)(1<<9 | 1<<8)




//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
//@ref SPI_BaudRate_PRESCAL
//*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*_*
